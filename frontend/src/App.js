...
// RPS app
const appIndex = 176248138;
const appAddress = "SXSMYXGMJFGRZZQLC3PL52QN2M7CIV7OKEV5WX3HIKT2TYMEQBXUAAWZ6M";
...
function App() {
  ...
  async function startRpsApplication(
    ...
    try {
      ...
      const accounts = [
        "DWMYG2QVKUUQP3S4EH7Z36XLET7YI3C2NVJ6A577HJV4YI3DWHDOVAIUTI",
      ];
  ...
  async function joinRpsApplication(sum) {
    try {
      ...
      const accounts = [
        "262Y6BGB5K7YUCWW6DVMWSETBX3IGLN7HXIAIKG7VIWSRKXEKEDZIIGMVE",
      ];
